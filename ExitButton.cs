...
public class ExitButton
{
    ...
    public ExitButton(Game1 game1, GraphicsDeviceManager graphicsDeviceManager, ContentManager contentManager, SceneManager sceneManager, Texture2D buttonTexture, Vector2 buttonPosition, SpriteFont font, string buttonText)
    {
        this.game1 = game1;
    ...
    public void Draw(SpriteBatch spriteBatch)
    {
        ...
        Vector2 textPosition = new Vector2(buttonPosition.X + (textSize.X / 2), buttonPosition.Y + (textSize.Y / 2));
